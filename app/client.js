...
const sequelize = new Sequelize(process.env.DATABASE_URL, {
  ...
  //   acquire: 30000 // The maximum time, in milliseconds, that pool
  // will try to get connection before throwing error
  // },
  // dialect: "postgres", // The dialect of the database you are connecting to
  // dialectOptions: { // An object of additional options, which are passed
  // directly to the connection library
  //   ssl: {
